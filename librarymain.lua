...
local lib = loadstring(game:HttpGet("https://raw.githubusercontent.com/brogg1v1/none2/refs/heads/main/Library.lua"))()
...
if not t.EAGLE then
    ...
    local fhop = loadstring(game:HttpGet("https://raw.githubusercontent.com/brogg1v1/none2/refs/heads/main/Null-Fire%2520Only%2520page.lua"))()
